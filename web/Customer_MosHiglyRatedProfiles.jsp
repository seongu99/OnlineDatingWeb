...
<%-- 
    Document   : Customer_MosHiglyRatedProfiles.jsp
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small>Most Highly Rated Profiles Form</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="Customer_MosHiglyRatedProfiles.jsp">Dashboard</a>
                            </li>
                            <li class="active">
                ...
                <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="MostHighlyRatedProfilesServlet" method="post">
                                <div class="form-group">
                                    <p>Click submit to see most highly rated profiles</p> 
