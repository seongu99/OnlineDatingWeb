<%-- 
    Document   : CustomerPastDate
    Created on : Nov 28, 2014, 7:48:34 PM
    Author     : seongu
--%>
...
<%@page import="DBWorks.LoginServlet"%>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small>Profile's Past Dates Form</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="CustomerPastDate.jsp">Dashboard</a>
                            </li>
                            <li class="active">
                ...
                <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="CustomerPastDatesServlet" method="post">
                                <div class="form-group">
                                    <p>Click submit to see past dates</p> 
