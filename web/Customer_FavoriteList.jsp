...
<%-- 
    Document   : Customer_FavoriteList.jsp
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Profile's Favorite List
                            <small>Profile's Favorite List Form</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="Customer_FavoriteList.jsp">Dashboard</a>
                            </li>
                            <li class="active">
                ...
                <!-- /.row -->
                  ...
                  <div class="row">
                        <div class="col-lg-6">
                            <form action="ProfileFavoriteListServlet" method="post">
                                <div class="form-group">
                                    <p>Click submit to see your favorite lists</p> 
