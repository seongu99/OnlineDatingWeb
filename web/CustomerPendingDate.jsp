<%-- 
    Document   : CustomerPendingDate
    Created on : Nov 28, 2014, 7:48:19 PM
    Author     : seongu
--%>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small>Profile's Pending Dates Form</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="CustomerPendingDate.jsp">Dashboard</a>
                            </li>
                            <li class="active">
                ...
                <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="CustomerPendingDatesServlet" method="post">
                                <div class="form-group">
                                    <p>Click submit to see pending dates</p> 
