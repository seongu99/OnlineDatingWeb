...
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Record Dates
                            <small>Recording Dates Form</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
           ...
           <form action="RecordDateServlet" method="post">
                    <div class="form-group">
                        ...
                        <p class="help-block">e.g: 2014-10-06 21:49:30</p>

                        <label>Location</label>
                        <input class="form-control" name="location">
                        <p class="help-block">e.g: The Mall </p>

                        <label>BookingFee</label>
                        <input class="form-control" name="bookingfee">
                        <p class="help-block">e.g: 90.91 </p>

                        <label>Comments</label>
                        <input class="form-control" name="comments">
                        <p class="help-block">e.g: Comments Here </p>

                        <label>User1Rating</label>
                        <input class="form-control" name="user1rating">
                        <p class="help-block">e.g: 3 </p>

                        <label>User2Rating</label>
                        <input class="form-control" name="user2rating">
                        <p class="help-block">e.g: 4 </p>
