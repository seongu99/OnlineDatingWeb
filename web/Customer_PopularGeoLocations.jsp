...
<%-- 
    Document   : Customer_PopularGeoLocations.jsp
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small>Popular geo-date locations form</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="Customer_PopularGeoLocations.jsp">Dashboard</a>
                            </li>
                            <li class="active">
                ...
                <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form action="PopularGeoLocationsServlet" method="post">
                                <div class="form-group">
                                    <p>Click submit to see popular geo-date locations</p> 
