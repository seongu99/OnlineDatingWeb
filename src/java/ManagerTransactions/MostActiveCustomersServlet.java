 ...
 * @author sherry
 */
public class MostActiveCustomersServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("Manager_ProduceAListofActiveCstmrs.jsp?message=" + URLEncoder.encode(message, "UTF-8"));
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(MostActiveCustomersServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
