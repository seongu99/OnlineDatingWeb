 ...
 * @author sherry
 */
public class CustomerPendingDatesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String query = "SELECT Profile1, Profile2 FROM Date WHERE Comments='Pending'";
       ...
       // DBConnection.ExecQuery(query1);
        ...
        response.sendRedirect("CustomerPendingDate.jsp?message=" + URLEncoder.encode(message, "UTF-8"));
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CustomerPendingDatesServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
