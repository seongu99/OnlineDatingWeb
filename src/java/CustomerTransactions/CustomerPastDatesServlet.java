 ...
 * @author sherry
 */
public class CustomerPastDatesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String query = "SELECT p.ProfileID FROM profile p,date d,person n WHERE d.Date_Time <=NOW() AND n.Email='" + 
                email + "'" + "AND n.SSN=p.OwnerSSN";
       ...
       // DBConnection.ExecQuery(query1);
        ...
        response.sendRedirect("CustomerPastDate.jsp?message=" + URLEncoder.encode(message, "UTF-8"));
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CustomerPastDatesServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
